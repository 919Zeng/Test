...
function makeSelectBox(thisId, imgsrc) {
    ...
    for (var i=0 ; i < obj.options.length ; i++) {
        ...
        newSelect += "            <tr>";
        newSelect += "                <td onMouseOver=this.style.backgroundColor='#111';return true;  onMouseOut=this.style.backgroundColor='#2b2b2b';return true; bgcolor=#2b2b2b height='" + optionHeight + "px' class='selectBoxOption' onMouseOver=\"this.className='selectBoxOptionOver'\" onMouseOut=\"this.className='selectBoxOption'\" onClick=\"selectThisValue('"+ objId + "'," + i + ",'" + nowValue + "','" + nowText + "')\" style='cursor:hand;' >" + nowText + "</td>";
    ...
    newSelect += "    <tr>";
    newSelect += "        <td style='padding-left:0px' bgcolor='#2b2b2b'>";
